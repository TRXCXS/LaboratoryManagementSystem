            ...
            <el-form ref="form"  label-width="80px">
                <el-form-item prop="no" label="上传图片">
                    ...
                    <el-upload
                        ...
                        :limit="1"
                        name="photo"
                        :data="{user_id:this.user.user_id,credit_record_id:c_id,description:des}"
                ...
                <el-form-item>
                    <el-button type="primary" @click="onSubmit">立即申诉</el-button>
...
export default {
    ...
    data() {
        return {
            api:this.GLOBAL.BASE_URL+"/appeal/",
            c_id: this.$route.query.credit_record_id,
            des:'',
    ...
    created() {
        console.log(this.$route.query.credit_record_id)
    },
    methods: {
        onSubmit() {
