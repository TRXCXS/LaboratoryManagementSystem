...
<!--        </div>-->
        ...
        <el-table :data="tableData" border stripe :header-cell-class-name="headerBg">
            ...
            <el-table-column prop="app_student" label="申请学生" >
            </el-table-column>
            ...
            <el-table-column prop="app_labNum" label="申请实验室编号" >
            </el-table-column>
            <el-table-column prop="app_reason" label="申请原因">
            </el-table-column>
            <el-table-column label="操作"  align="center" width="190px">
                <template slot-scope="scope">
                    <el-button type="success"  @click="approve(scope.row.user_id)" >通过 <i class="el-icon-edit"></i></el-button>
                    <el-button type="danger"   @click="disapprove(scope.row.user_id)">不通过 <i class="el-icon-remove-outline"></i></el-button>
                </template>
            </el-table-column>
        </el-table>
